...
from .criterion import LabelSmoothing, CrossEntropyOnMean, MSEOnMean, LikelihoodMSE, GaussianSamplingCrossEntropyLoss, GaussianSamplingPredict, SampleBasedEarthMoverLoss, FidelityLoss
