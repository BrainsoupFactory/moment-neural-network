...
changelogs = [
  ('../mnn-changelog.md', 'apis/auto/brainpy-changelog.md'),
]
...
project = 'Moment Neural Network'
copyright = '2022-2025, MNN'
author = 'MNN Team'

# The full version, including alpha/beta/rc tags
release = mnn.__version__
...
html_title = "Mooment Neural Network (MNN) documentation"
